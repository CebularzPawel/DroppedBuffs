...
public class ModModelLayers {
    ...
    public static final ModelLayerLocation LUCK_BUFF_LAYER = new ModelLayerLocation(
            new ResourceLocation(DroppedBuffs.MOD_ID,"luck_buff_layer"),"main");
    public static final ModelLayerLocation WATER_BREATHING_BUFF_LAYER = new ModelLayerLocation(
            new ResourceLocation(DroppedBuffs.MOD_ID,"water_breathing_buff_layer"),"main");
    public static final ModelLayerLocation NIGHT_VISION_BUFF_LAYER = new ModelLayerLocation(
            new ResourceLocation(DroppedBuffs.MOD_ID,"night_vision_buff_layer"),"main");
    public static final ModelLayerLocation FIRE_RESISTANCE_BUFF_LAYER = new ModelLayerLocation(
            new ResourceLocation(DroppedBuffs.MOD_ID,"fire_resistance_buff_layer"),"main");
